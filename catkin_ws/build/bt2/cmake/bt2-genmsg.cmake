...
message(STATUS "bt2: 0 messages, 0 services")
...
### Generating Module File
_generate_module_eus(bt2
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/bt2
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(bt2_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(bt2_generate_messages bt2_generate_messages_eus)

# add dependencies to all check dependencies targets

# target for backward compatibility
add_custom_target(bt2_geneus)
add_dependencies(bt2_geneus bt2_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS bt2_generate_messages_eus)
...
### Generating Module File
_generate_module_nodejs(bt2
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/bt2
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(bt2_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(bt2_generate_messages bt2_generate_messages_nodejs)

# add dependencies to all check dependencies targets

# target for backward compatibility
add_custom_target(bt2_gennodejs)
add_dependencies(bt2_gennodejs bt2_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS bt2_generate_messages_nodejs)
...
if(TARGET actionlib_msgs_generate_messages_cpp)
  add_dependencies(bt2_generate_messages_cpp actionlib_msgs_generate_messages_cpp)
endif()
if(TARGET std_msgs_generate_messages_cpp)
  add_dependencies(bt2_generate_messages_cpp std_msgs_generate_messages_cpp)
endif()

if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/bt2)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/bt2
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET actionlib_msgs_generate_messages_eus)
  add_dependencies(bt2_generate_messages_eus actionlib_msgs_generate_messages_eus)
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(bt2_generate_messages_eus std_msgs_generate_messages_eus)
endif()
...
if(TARGET actionlib_msgs_generate_messages_lisp)
  add_dependencies(bt2_generate_messages_lisp actionlib_msgs_generate_messages_lisp)
endif()
if(TARGET std_msgs_generate_messages_lisp)
  add_dependencies(bt2_generate_messages_lisp std_msgs_generate_messages_lisp)
endif()

if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/bt2)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/bt2
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET actionlib_msgs_generate_messages_nodejs)
  add_dependencies(bt2_generate_messages_nodejs actionlib_msgs_generate_messages_nodejs)
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(bt2_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/bt2)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/bt2\")")
  # install generated code
  install(
...
if(TARGET actionlib_msgs_generate_messages_py)
  add_dependencies(bt2_generate_messages_py actionlib_msgs_generate_messages_py)
endif()
